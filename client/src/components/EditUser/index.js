...
function EditUser ({setEditUser,updateUser,handleDeleteShow}) {
    ...
    const handleSubmit=(e)=>{
        e.preventDefault()
        updateUser({variables:{userName:name,email,password:'placeholder',location:`${street}|${city}|${states}|${zip}`}})
        setEmail('')

...
const typeDefs = gql`
    ...
    type Mutation {
        ...
        addCharity(name: String!, website: String, image: String, logo: String, description: String, mission: String): Charity
        updateCharity(charityId: ID!, name: String!, website: String, image: String, logo: String, description: String, mission: String): Charity
